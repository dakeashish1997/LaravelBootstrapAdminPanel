...
class UpdateUserTwoFactorAuth extends Component
{
    public $password = '';
    public $alert = '';
    public $twoFaQr = '';
    ...
    {
        return view('livewire.update-user-two-factor-auth');
    }
    ...
    public function confirmPasswordForTwoFactorAuthentication()
    {
        $this->password = '';
        $this->alert = '';
        $this->js("$('#modal-two-fa-confirm').modal('show');");
    }
    ...
    public function twoFactorAuthenticationPasswordConfirmed()
    {
        ...
        $this->js("$('#modal-two-fa-confirm').modal('hide');");
    }
