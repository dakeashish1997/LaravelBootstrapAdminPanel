<div>
    <div class="card card-default">
        ...
        <div wire:ignore.self class="modal" id="modal-logout-other-browser-sessions">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="password" id="password" name="password" class="form-control" placeholder="Password" wire:model.defer="password" wire:keydown.enter="logoutOtherSessions">
                        <p style="color: red">
                            {{$alert}}
                        </p>
                    </div>
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" wire:click="logoutOtherSessions">Logout Other Sessions</button>
                    </div>
                </div>
            </div>
        </div>
